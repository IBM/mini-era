...
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = mio_input.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL
...
def distorted_inputs():
  ...
  """
  #images, labels = mio_input.distorted_inputs(batch_size=FLAGS.batch_size)
  return mio_input.distorted_inputs(batch_size=FLAGS.batch_size)
  #if FLAGS.use_fp16:
...
def inputs():
  ...
  Returns:
    ...
    labels: Labels. 1D tensor of [batch_size] size.
  """
  #images, labels = mio_input.inputs(batch_size=FLAGS.batch_size)
  #if FLAGS.use_fp16:
  #  images = tf.cast(images, tf.float16)
  #  labels = tf.cast(labels, tf.float16)
  #return images, labels
  return mio_input.inputs(batch_size=FLAGS.batch_size)

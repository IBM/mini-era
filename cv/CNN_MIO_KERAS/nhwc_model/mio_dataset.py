...
np_features = np.zeros((NUM_TRAINING_IMAGES, IMG_HEIGHT, IMG_WIDTH, NUM_CHANNELS), np.float32)
np_labels = np.zeros((NUM_TRAINING_IMAGES,1),np.uint64)
np_test_features = np.zeros((NUM_TEST_IMAGES, IMG_HEIGHT, IMG_WIDTH, NUM_CHANNELS), np.float32)
